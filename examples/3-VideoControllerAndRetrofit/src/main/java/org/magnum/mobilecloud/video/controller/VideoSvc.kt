...
class VideoSvc {
    ...
    val videoList: List<Video>
        @RequestMapping(value = VideoSvcApi.VIDEO_SVC_PATH, method = arrayOf(RequestMethod.GET))
        @ResponseBody
        get() = videos
    ...
    //
    @RequestMapping(value = VideoSvcApi.VIDEO_SVC_PATH, method = arrayOf(RequestMethod.POST))
    @ResponseBody
    fun addVideo(@RequestBody v: Video): Boolean {
        return videos.add(v)
    }
